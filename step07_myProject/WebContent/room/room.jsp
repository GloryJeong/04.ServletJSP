...
<body>
	...
	<form align = "right" action="room?command=select" method="get">
		...
		<input name="selectId" placeholder="객실 번호로  검색"/> 
	...
	<tr>
        <td bgcolor="#336699">
            <p align="center">
            <font color="white"><b><span style="font-size:9pt;">객실 ID</span></b></font></p>
        </td>
        <td bgcolor="#336699">
            <p align="center"><font color="white"><b><span style="font-size:9pt;">최대 수용 인원</span></b></font></p>
        </td>
        <td bgcolor="#336699">
            <p align="center"><font color="white"><b><span style="font-size:9pt;">가 격</span></b></font></p>
        </td>
        <td bgcolor="#336699">
            <p align="center"><font color="white"><b><span style="font-size:9pt;">지 역</span></b></font></p>
        </td>
        <td bgcolor="#336699">
	...
	<c:forEach items="${requestScope.roomList}" var="data">
		    <tr>
		        <td bgcolor="">
		            <p align="center"><span style="font-size:9pt;">${data.roomId}</span></p>
		        </td>
		        <td bgcolor="">
